...
describe('day-3', () => {
  describe('solvePuzzle1', () => {
    it('should solve puzzle with example input', async () => {
      const testInput = await readPuzzleInput(null, '../day-3/test-input');
      const testOutput = await readPuzzleInput(null, '../day-3/test-output');
  ...
  describe('solvePuzzle2', () => {
    it('should solve puzzle with example input', async () => {
      const testInput = await readPuzzleInput(null, '../day-3/test-input2');
      const testOutput = await readPuzzleInput(null, '../day-3/test-output2');
