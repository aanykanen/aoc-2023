...
describe('day-2', () => {
  describe('solvePuzzle1', () => {
    it('should solve puzzle with example input', async () => {
      const testInput = await readPuzzleInput(null, '../day-2/test-input');
      const testOutput = await readPuzzleInput(null, '../day-2/test-output');
  ...
  describe('solvePuzzle2', () => {
    it('should solve puzzle with example input', async () => {
      const testInput = await readPuzzleInput(null, '../day-2/test-input2');
      const testOutput = await readPuzzleInput(null, '../day-2/test-output2');
